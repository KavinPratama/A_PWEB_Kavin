...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<MetodePembayaran>|MetodePembayaran whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MetodePembayaran>|MetodePembayaran whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MetodePembayaran>|MetodePembayaran whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MetodePembayaran>|MetodePembayaran newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MetodePembayaran>|MetodePembayaran newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MetodePembayaran>|MetodePembayaran query()
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<MetodePembayaran>|MetodePembayaran timeout(int $seconds)
     ...
     */
    class MetodePembayaran extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\PaketJoki
     *
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\MetodePembayaran> $metodePembayaran
     * @property-read int|null $metode_pembayaran_count
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereKode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereNama($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereKategori($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereStok($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereHarga($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereTanggal($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereFoto($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki query()
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki tersedia() {@see App\Models\PaketJoki::scopeTersedia()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectExpression($expression, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     ...
     * @method static mixed lockForUpdate()
     * @method static mixed sharedLock()
     * @method static \Illuminate\Database\Eloquent\Builder<PaketJoki>|PaketJoki timeout(int $seconds)
     * @method static mixed beforeQuery(callable $callback)
     * @method static mixed applyBeforeQueryCallbacks()
     * @method static mixed afterQuery(Closure $callback)
     * @method static mixed applyAfterQueryCallbacks($result)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class PaketJoki extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
