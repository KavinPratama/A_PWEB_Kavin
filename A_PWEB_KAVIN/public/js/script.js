const defaultDataJoki = [
    { id: '1', kode: 'JR-01', nama: 'Epic ke Legend', kategori: 'Joki Rank', stok: '10', harga: '50000', tanggal: '2026-04-27' },
    { id: '2', kode: 'JH-01', nama: 'Fanny (Per Match)', kategori: 'Joki Hero', stok: '20', harga: '5000', tanggal: '2026-04-27' },
    { id: '3', kode: 'JG-01', nama: 'Mabar Mythic (Per Jam)', kategori: 'Joki Gendong', stok: '5', harga: '25000', tanggal: '2026-04-27' }
];

let jokiData = JSON.parse(localStorage.getItem('dataJokssML_V2')) || defaultDataJoki;
let editId = null;
...
form.addEventListener('submit', (e) => {
    ...
    localStorage.setItem('dataJokssML_V2', JSON.stringify(jokiData));
    form.reset();
    renderFilteredData();
});
