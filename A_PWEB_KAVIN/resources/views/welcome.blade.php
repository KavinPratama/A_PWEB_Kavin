    ...
    <nav class="bg-white dark:bg-[#121316] border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 flex justify-between items-center">
            ...
            <div class="flex gap-6 pt-4">
                ...
                <a href="{{ route('transaksi.index') }}" class="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition pb-3">
            ...
            <div class="flex gap-3 pb-2">
                @auth
                    <a href="{{ route('dashboard') }}" class="bg-[#5bcfe6]/20 hover:bg-[#5bcfe6]/30 text-[#5bcfe6] px-4 py-1.5 rounded-lg text-sm font-bold border border-[#5bcfe6]/50 transition flex items-center gap-2">
                        <i class="fa-solid fa-user"></i> Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white text-sm font-bold px-3 py-1.5 transition flex items-center gap-2">
                        <i class="fa-solid fa-right-to-bracket"></i> Masuk
                    </a>
                    <a href="{{ route('register') }}" class="bg-[#5bcfe6] hover:bg-[#4ab8ce] text-black px-4 py-1.5 rounded-lg text-sm font-bold transition shadow-[0_0_10px_rgba(91,207,230,0.3)] flex items-center gap-2">
    ...
    <main class="max-w-7xl mx-auto px-4 pt-8">
        ...
        <div class="mb-10 p-6 lg:p-8 bg-gradient-to-r from-cyan-50 dark:from-[#1f2125] to-white dark:to-[#121316] border border-cyan-100 dark:border-gray-700 rounded-2xl shadow-xl dark:shadow-2xl flex items-center gap-6 transition-colors duration-300">
            <div class="h-20 w-20 bg-white dark:bg-[#2d2f36] rounded-full flex items-center justify-center border border-gray-200 dark:border-gray-600 shadow-lg shrink-0 transition-colors duration-300">
                <img src="{{ asset('images/globalhero.png') }}" alt="Jokss" class="w-12 h-12 object-contain drop-shadow-lg">
            </div>
            <div>
        ...
        <section class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <!-- Card 1: Joki Rank -->
                <a href="{{ route('paket.create', ['type' => 'rank']) }}" class="group bg-white dark:bg-[#1f2125] border border-gray-200 dark:border-gray-700 hover:border-[#cda06b] dark:hover:border-[#cda06b] rounded-2xl overflow-hidden shadow-lg dark:shadow-xl transition transform hover:-translate-y-1 block relative">
                    ...
                    <div class="h-44 w-full bg-gray-50 dark:bg-[#121316] flex items-center justify-center p-6 border-b border-gray-100 dark:border-gray-800 transition-colors duration-300">
                        <img src="{{ asset('images/roaster.png') }}" alt="Joki Rank" class="h-full object-contain drop-shadow-[0_5px_15px_rgba(205,160,107,0.3)] group-hover:scale-110 transition duration-500">
                    </div>
                    <div class="p-5">
                ...
                <!-- Card 2: Joki Hero -->
                <a href="{{ route('paket.create', ['type' => 'hero']) }}" class="group bg-white dark:bg-[#1f2125] border border-gray-200 dark:border-gray-700 hover:border-[#5bcfe6] dark:hover:border-[#5bcfe6] rounded-2xl overflow-hidden shadow-lg dark:shadow-xl transition transform hover:-translate-y-1 block relative">
                    ...
                    <div class="h-44 w-full bg-gray-50 dark:bg-[#121316] flex items-center justify-center p-6 border-b border-gray-100 dark:border-gray-800 transition-colors duration-300">
                        <img src="{{ asset('images/globalhero.png') }}" alt="Joki Hero" class="h-full object-contain drop-shadow-[0_5px_15px_rgba(91,207,230,0.3)] group-hover:scale-110 transition duration-500">
                    </div>
                    <div class="p-5">
                ...
                <!-- Card 3: Joki Gendong -->
                <a href="{{ route('paket.create', ['type' => 'gendong']) }}" class="group bg-white dark:bg-[#1f2125] border border-gray-200 dark:border-gray-700 hover:border-[#f59e0b] dark:hover:border-[#f59e0b] rounded-2xl overflow-hidden shadow-lg dark:shadow-xl transition transform hover:-translate-y-1 block relative">
                    ...
                    <div class="h-44 w-full bg-gray-50 dark:bg-[#121316] flex items-center justify-center p-6 border-b border-gray-100 dark:border-gray-800 transition-colors duration-300">
                        <img src="{{ asset('images/epic.png') }}" alt="Joki Gendong" class="h-full object-contain drop-shadow-[0_5px_15px_rgba(245,158,11,0.3)] group-hover:scale-110 transition duration-500">
                    </div>
                    <div class="p-5">
